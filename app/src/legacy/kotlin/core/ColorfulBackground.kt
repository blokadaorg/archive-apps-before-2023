...
class ColorfulBackground(
    ...
    private fun positionToGradient(position: Int): IntArray {
        when (position % 5) {
            0 -> return colors(R.array.gradient6)
            1 -> return colors(R.array.gradient2)
            2 -> return colors(R.array.gradient3)
            3 -> return colors(R.array.gradient4)
            4 -> return colors(R.array.gradient5)
            else -> return colors(R.array.gradient1)
        }
    }
