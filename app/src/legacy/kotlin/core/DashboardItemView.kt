...
data class DashboardSection(
        val main: DashboardItem,
        val subsections: List<DashboardItem> = emptyList(),
...
fun createDashboardSections(ktx: AndroidKontext): List<DashboardSection> {
    ...
    sections += DashboardSection(
            ...
            subsections = listOf(
                    DashboardItem(R.drawable.ic_apps, R.string.dashboard_log_name, ViewDash(R.layout.dash_placeholder)),
                    DashboardItem(R.drawable.ic_settings_outline, R.string.dashboard_ads_settings_name, ViewDash(R.layout.dash_placeholder))
            ),
    ...
    sections += DashboardSection(
            ...
            subsections = listOf(
                    DashboardItem(R.drawable.ic_hexagon, R.string.dashboard_apps_system_name, ViewDash(R.layout.dash_placeholder))
            ),
    ...
    sections += DashboardSection(
            ...
            subsections = listOf(
                    DashboardItem(R.drawable.ic_settings_outline, R.string.dashboard_dns_settings_name, AdsDash(ktx))
            ),
            ...
            subsections = listOf(
                    ...
                    DashboardItem(
                            ...
                            dash = WebDash(LazyKodein(ktx.di), pages.credits,
                                    reloadOnError = true, javascript = true)),
                    DashboardItem(R.drawable.ic_new_releases, R.string.dashboard_update_name, UpdatesDash(ktx))
            ),
