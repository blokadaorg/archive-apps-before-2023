...
internal class BlockaTunnel(
    ...
    inline fun fromDevice(ktx: Kontext, fromDevice: ByteArray, length: Int) {
...
//                    buffers.returnBuffer(destinationId)
    ...
    inline fun toDevice(ktx: Kontext, source: ByteArray, length: Int) {
        var i = 0
        do {
            op.rewind()
...
//                buffers.returnBuffer(destinationBufferId)
    ...
    private inline fun interceptDns(ktx: Kontext, packetBytes: ByteArray, length: Int): Boolean {
    ...
    private inline fun parseDns(ktx: Kontext, packetBytes: ByteArray, length: Int): Boolean {
...
//            ktx.v("rewriting dns request")
    ...
    private inline fun dstAddress4(ktx: Kontext, packet: ByteArray, length: Int, ip: ByteArray): Boolean {
        return (
    ...
    private inline fun srcAddress4(ktx: Kontext, packet: ByteBuffer, ip: ByteArray): Boolean {
        return (
    ...
    private inline fun rewriteSrcDns4(ktx: Kontext, packet: ByteBuffer, length: Int) {
        val originEnvelope = try {
...
//            ktx.v("rewritten back dns response")
    ...
    private inline fun toDeviceFakeDnsResponse(ktx: Kontext, response: ByteArray, originEnvelope: Packet?) {
...
//        val destination = buffers[destinationBufferId]
    ...
    inline fun createTunnel(ktx: Kontext) {
    ...
    inline fun forward(ktx: Kontext, nvm: Int) {
...
//            buffers.returnAllBuffers()
    ...
    private inline fun setupErrorsPipe() = {
        val pipe = Os.pipe()
        error = pipe[0]
    ...
    private inline fun setupDevicePipe(input: FileInputStream) = {
    ...
    private inline fun setupPolls(ktx: Kontext, errors: StructPollfd, device: StructPollfd) = {
